...
mod tests {
    ...
    fn arch_new_test() {
        ...
        assert_eq!(created_by_method.cpu_type as i32, x86_64.cpu_type as i32,"Cpu type is not equal");
        assert_eq!(created_by_method.cpu_sub_type, x86_64.cpu_sub_type, "Cpu sub-type is not equal");
        assert_eq!(created_by_method.offset, x86_64.offset, "Offset is not equal");
    ...
    fn arch_new_from_byte_test() {
        let arch_header: [u8; 20] = [1,0,0,7,0,0,0,3,0,0,64,0,0,0,128,240,0,0,0,14];
